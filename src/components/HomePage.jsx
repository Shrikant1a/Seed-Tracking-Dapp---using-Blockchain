    ...
    <div className="main-home-page">
      ...
      <main>
        <section className="quote-section">
          <p>
            Agriculture is Best, Enterprise is Acceptable, But Avoid Being On A{" "}
            <span className="fixed-wage">Fixed Wage</span>
          </p>
        </section>
        ...
        <section className="categories">
          <div className="category-grid">
            <div className="category-item">
              <img src="/image/cattle farm.jpg" alt="Cattle Farm" />{" "}
              {/* Adjust path */}
      ...
      <footer className="footer">
        <div className="footer-container">
          <p>🌱 GreenLedger © {new Date().getFullYear()} — Built on Ethereum</p>
