...
const contractAddress = '0xFa366483967ead1C0C10F99362B5CB6E996e4F22'; // 🔁 Replace this with your actual deployed address
...
<div className="home-header-content">
      ...
      <h2 className="text-2xl font-bold mb-4 text-center">🌱 Seed Batch Details 🌱</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {products.map((p, index) => (
            <div key={index} className="bg-white rounded-xl shadow p-4">
              ...
              <p><strong>MFG Date:</strong> {p.mfgDate}</p>
              <p><strong>EXP Date:</strong> {p.expDate}</p>
